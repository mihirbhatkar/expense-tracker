...
// receives user data and adds expense
...
const addExpense = asyncHandler(async (req, res) => {
  ...
  if (user) {
    ...
    res.status(200).json({ exp, message: "Expense saved successfully" });
  } else {
    res.status(404);
...
// receives an expense id and deletes it from database
...
// receives user data and expense data, makes changes to expense
